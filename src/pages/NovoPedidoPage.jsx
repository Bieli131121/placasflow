...
export default function NovoPedidoPage() {
  ...
  const handleClienteSelect = (id) => {
    ...
    if (c) {
      setForm(f => ({ ...f, clienteId: id, nomeCliente: c.nome, cpf: c.cpf, tel: c.tel }))
    } else {
      set('clienteId', '')
    }
  }
  ...
  return (
    <>
      <div className="page-header">
        <div className="page-title">Novo <span>Pedido</span></div>
      ...
      <form className="form-card" onSubmit={handleSubmit}>
        <div className="form-row">
          ...
          <div className="form-group">
            ...
            <input value={form.modelo} onChange={e => set('modelo', e.target.value)} placeholder="Ex: HB20, Civic" />
          </div>
          <div className="form-group">
        ...
        <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end', marginTop: '1rem' }}>
          ...
          <button type="submit" className="btn btn-primary">💾 Salvar Pedido</button>
        </div>
      </form>
    </>
  )
